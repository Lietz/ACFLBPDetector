function chns = mychnsCompute( I, varargin )
...
% single scale, for (fast) multi-scale channel computation see mychnsPyramid.
%
...
%
% See also rgbConvert, gradientMag, gradientHist, mychnsPyramid
%
